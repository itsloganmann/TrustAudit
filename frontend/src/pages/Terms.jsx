          ...
          {unresolved && (
            <div className="flex items-start gap-3 rounded-xl border border-amber-200 bg-amber-50 p-4 my-4 text-amber-800">
              ...
              <div className="text-[13px] leading-relaxed">
                ...
                <p>
                  Registration and jurisdiction details will be updated once
                  the legal entity is formed. Until then, reach the founders
                  at{" "}
                  <a
                    href="mailto:support@trustaudit.in"
                    className="underline text-amber-900"
                  >
                    support@trustaudit.in
                  </a>
                  .
                </p>
              </div>
